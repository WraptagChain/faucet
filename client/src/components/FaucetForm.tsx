...
const FaucetForm = (props: any) => {
    ...
    async function updateBalance() {
        ...
        // const provider = new ethers.providers.JsonRpcProvider('"https://rpc.metheus.network/ext/bc/21Z7pN9Z6VfmMo8jjhDQYyYJS5MB7MftZSuKrmenhmwADCWWJH/rpc"');
        // const res = await provider.getBalance('0xae50cfBdecBEa5565601C53f10Ae1945E8D13018')
